...
public class OAuth2LoginSuccessHandler implements AuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(
        ...
        // TODO: NOTE that this success handler responds with the login response that
        // contains the JWT token directly in JSON and this is a wrong production flow.
        // Instead,
        // the success handler should redirect the user back to the client (front-end or
        // mobile app) with a mechanism that allows them to later request the generated
        // JWT token like sending a short-lived code that corresponds to the user, so
        // the client could later send this code and exchange it with the actual JWT
        // token for security best practices.
        // I'll leave it as is just to test the OAuth2 logic in the dev phase only.
